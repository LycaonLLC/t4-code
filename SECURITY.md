...
- Pairing credentials are encrypted with platform secure storage. Reports about credential handling, the pairing flow, or the `t4-code://` deep-link handler are especially welcome.
