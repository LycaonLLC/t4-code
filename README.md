...
T4 Code v0.1.12 was verified with OMP 16.5.1 built from [`ea6bef2f`](https://github.com/lyc-aon/oh-my-pi/commit/ea6bef2fc0bbcbc050cebcdc6bc1a13b644705f0), tagged [`t4code-16.5.1-appserver-2`](https://github.com/lyc-aon/oh-my-pi/tree/t4code-16.5.1-appserver-2). That public integration is based on the official upstream [`v16.5.1`](https://github.com/can1357/oh-my-pi/tree/v16.5.1) tag at [`14b5da76`](https://github.com/can1357/oh-my-pi/commit/14b5da76a9aece9a469288718d22c3d624daf033). It carries forward T4's appserver and lifecycle integration, adds bounded prompt-image upload and transcript-image readback, and tightens public wire-frame decoding and RPC event bounds. The official upstream v16.5.1 tag has no `appserver` command, so it cannot host T4 Code. The verified runtime is a normal build from the public `lyc-aon/oh-my-pi` source; T4 Code does not depend on private home-directory files, an auth broker, or a custom Codex CLI fork. T4 Code vendors `@oh-my-pi/app-wire` 0.5.5 from integration commit [`ea6bef2f`](https://github.com/lyc-aon/oh-my-pi/commit/ea6bef2fc0bbcbc050cebcdc6bc1a13b644705f0), source tree `d67e3d7aca981a70e5c17a892d3fafb299cdb774`.
