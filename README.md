...
The current source tree advances the vendored contract to `@oh-my-pi/app-wire` 0.6.1 from integration commit [`50b233fd`](https://github.com/lyc-aon/oh-my-pi/commit/50b233fdb7803a09949574614ffa3e0ea780bf5e), source tree `47ac86a9f4cb64e27700644e0930b48591eed41a`. This adds the bounded cross-session transcript search and historical context contract. The published v0.1.23 package remains pinned to the `d57dcd85` contract above.
