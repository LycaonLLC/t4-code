...
T4 Code v0.1.23 was verified with OMP 17.0.4 built from [`469bf579`](https://github.com/lyc-aon/oh-my-pi/commit/469bf579dca26c86ffe760a4a4e102d026279ed8), tagged [`t4code-17.0.4-appserver-2`](https://github.com/lyc-aon/oh-my-pi/tree/t4code-17.0.4-appserver-2). That public integration is based on the official upstream [`v17.0.4`](https://github.com/can1357/oh-my-pi/tree/v17.0.4) tag at [`3fdd85ab`](https://github.com/can1357/oh-my-pi/commit/3fdd85ab6c6bab6c0cdee80abbbec0981740a5c0). It carries forward profile-scoped appservers, lock-aware terminal-session observation, complete transcript reconciliation, the cooperative `/continue-in-t4` handoff, host-scoped usage and broker status, and deterministic session ordering. Fork CI rechecks the exact upstream ancestry and release gates before publishing binaries. The official upstream v17.0.4 tag has no `appserver` command, so it cannot host T4 Code. The verified runtime is a normal build from the public `lyc-aon/oh-my-pi` source. T4 Code vendors `@oh-my-pi/app-wire` 0.5.8 from integration commit [`33615123`](https://github.com/lyc-aon/oh-my-pi/commit/33615123ff986fc9cadf645463b4fed17e8b9f35), source tree `e36475dc81dd4c3703eb207ae466f85947b33525`.
