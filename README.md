...
The current source tree advances the vendored contract to `@oh-my-pi/app-wire` 0.6.1 from integration commit [`614b23b7`](https://github.com/lyc-aon/oh-my-pi/commit/614b23b75345ae0d546056d4c2cda191a9008308), source tree `f45d610346fd4bd27cfbd9409a67e4f8f52bca3a`. This adds the bounded cross-session transcript search and historical context contract. The published v0.1.23 package remains pinned to the `d57dcd85` contract above.
