// Release contract guard: exact v0.1.24 asset names and URLs, and the
...
describe("release assets", () => {
  it("carries the five contracted v0.1.24 filenames", () => {
    expect(RELEASE_ASSETS.map((a) => a.filename)).toEqual([
      "T4-Code-0.1.24-android.apk",
      "T4-Code-0.1.24-linux-amd64.deb",
      "T4-Code-0.1.24-linux-x86_64.AppImage",
      "T4-Code-0.1.24-mac-arm64.dmg",
      "T4-Code-0.1.24-mac-arm64.zip",
    ]);
  });
  ...
  it("targets the public LycaonLLC repo", () => {
    ...
    expect(RELEASE_TAG).toBe("v0.1.24");
    expect(RELEASE_VERSION).toBe("0.1.24");
