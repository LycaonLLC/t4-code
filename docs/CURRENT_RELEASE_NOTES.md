...
T4 Code v0.1.23 vendors app-wire 0.5.8 from integration commit [33615123](https://github.com/lyc-aon/oh-my-pi/commit/33615123ff986fc9cadf645463b4fed17e8b9f35), source tree `e36475dc81dd4c3703eb207ae466f85947b33525`. The client contract remains `omp-app/1`.

The matching OMP 17.0.4 runtime is built from commit [469bf579](https://github.com/lyc-aon/oh-my-pi/commit/469bf579dca26c86ffe760a4a4e102d026279ed8) and tagged [t4code-17.0.4-appserver-2](https://github.com/lyc-aon/oh-my-pi/tree/t4code-17.0.4-appserver-2). It carries forward profile-scoped appservers, lock-aware terminal-session observation, complete transcript reconciliation, session lifecycle management, image transport, host-scoped usage and broker status, and the cooperative `/continue-in-t4` handoff.
